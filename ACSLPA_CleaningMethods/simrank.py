...
def simrank(G, c=0.8, max_iter=10, remove_neighbors=False, remove_self=False, dump_process=False):
    ...
    for i, u in enumerate(G.nodes()):
      ...
      for v in G.nodes():
        if u == v:
          continue
        s_uv = 0.0
        for n_u in list(G.neighbors(u)):
          for n_v in list(G.neighbors(v)):
